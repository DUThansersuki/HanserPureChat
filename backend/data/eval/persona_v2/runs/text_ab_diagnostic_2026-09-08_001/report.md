...
- 生成成功：32 / 32
- Judge 成功：32 / 32
- 双向一致 case：11；不一致率：0.312
- Consensus：{"tie": 1, "A": 3, "inconsistent": 5, "B": 7}
- A/B hard failures：0 / 1
- 配对 group composite delta（B-A）：{"mean": 0.243056, "ci95": [-0.180556, 0.652778], "groups": 12, "method": "paired group bootstrap", "samples": 10000}
- Style 非空覆盖 A/B：15 / 15

结论：**反向**

理由：candidate generation or hard-gate failure
